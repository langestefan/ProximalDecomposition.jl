using ProximalDecomposition
using Documenter

DocMeta.setdocmeta!(ProximalDecomposition, :DocTestSetup, :(using ProximalDecomposition); recursive = true)
...
makedocs(;
    modules = [ProximalDecomposition],
    authors = "Stefan de Lange <langestefan@msn.com>",
    repo = "https://github.com/langestefan/ProximalDecomposition.jl/blob/{commit}{path}#{line}",
    sitename = "ProximalDecomposition.jl",
    format = Documenter.HTML(; canonical = "https://langestefan.github.io/ProximalDecomposition.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/langestefan/ProximalDecomposition.jl")
